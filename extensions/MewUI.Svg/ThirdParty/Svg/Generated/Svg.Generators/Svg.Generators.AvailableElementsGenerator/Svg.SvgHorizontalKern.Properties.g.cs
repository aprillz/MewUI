...
namespace Svg
{
    public partial class SvgHorizontalKern
    {
        ...
        internal static List<Type> SvgHorizontalKernClassNames = new List<Type>() { typeof(Svg.SvgHorizontalKern) };
        ...
        {
            foreach (var kvp in SvgHorizontalKernProperties)
            {
        ...
        {
            if (SvgHorizontalKernProperties.TryGetValue(attributeName, out var propertyDescriptor))
            {
