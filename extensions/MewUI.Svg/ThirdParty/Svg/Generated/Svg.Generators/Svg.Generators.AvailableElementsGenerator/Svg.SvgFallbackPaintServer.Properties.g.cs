...
namespace Svg
{
    public partial class SvgFallbackPaintServer
    {
        ...
        internal static List<Type> SvgFallbackPaintServerClassNames = new List<Type>() { typeof(Svg.SvgFallbackPaintServer) };
        ...
        {
            foreach (var kvp in SvgFallbackPaintServerProperties)
            {
        ...
        {
            if (SvgFallbackPaintServerProperties.TryGetValue(attributeName, out var propertyDescriptor))
            {
