...
namespace Svg
{
    public partial class SvgVerticalKern
    {
        ...
        internal static List<Type> SvgVerticalKernClassNames = new List<Type>() { typeof(Svg.SvgVerticalKern) };
        ...
        {
            foreach (var kvp in SvgVerticalKernProperties)
            {
        ...
        {
            if (SvgVerticalKernProperties.TryGetValue(attributeName, out var propertyDescriptor))
            {
