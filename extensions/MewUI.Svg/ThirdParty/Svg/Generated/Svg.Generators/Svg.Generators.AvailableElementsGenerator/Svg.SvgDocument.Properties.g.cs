...
namespace Svg
{
    public partial class SvgDocument
    {
        ...
        internal static List<Type> SvgDocumentClassNames = new List<Type>() { typeof(Svg.SvgDocument) };
        ...
        {
            foreach (var kvp in SvgDocumentProperties)
            {
        ...
        {
            if (SvgDocumentProperties.TryGetValue(attributeName, out var propertyDescriptor))
            {
