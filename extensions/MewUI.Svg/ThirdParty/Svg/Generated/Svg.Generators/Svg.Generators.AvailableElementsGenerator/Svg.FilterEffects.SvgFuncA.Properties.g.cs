...
namespace Svg.FilterEffects
{
    public partial class SvgFuncA
    {
        ...
        internal static List<Type> SvgFuncAClassNames = new List<Type>() { typeof(Svg.FilterEffects.SvgFuncA) };
        ...
        {
            foreach (var kvp in SvgFuncAProperties)
            {
        ...
        {
            if (SvgFuncAProperties.TryGetValue(attributeName, out var propertyDescriptor))
            {
