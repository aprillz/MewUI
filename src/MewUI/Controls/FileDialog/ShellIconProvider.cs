...
internal interface IShellIconProvider
{
...
{
    private static IShellIconProvider? _current;

    public static IShellIconProvider ForCurrentOS()
    {
        if (_current != null)
        {
            return _current;
        ...
        {
            _current = new WindowsShellIconProvider();
        }
        else if (OperatingSystem.IsMacOS())
        {
            _current = new MacShellIconProvider();
        }
        else if (OperatingSystem.IsLinux())
        {
            _current = new LinuxShellIconProvider();
        }
        else
        {
            _current = new NullShellIconProvider();
        }
